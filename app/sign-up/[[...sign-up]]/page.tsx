...
export default function SignUpPage() {
  useEffect(() => {
    // Configure Clerk to use sign-up webhook mode
    if (typeof window !== 'undefined') {
      // Set a flag to indicate this is sign-up mode
      sessionStorage.setItem('clerk_mode', 'signup');
    }
  }, []);
    ...
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold gradient-text-primary">Join OrangeURL</h1>
        ...
        <SignUp 
          ...
          redirectUrl="/api/auth/callback?mode=signup"
        />
      </div>
    </div>
  );
